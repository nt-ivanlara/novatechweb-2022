...
const NavBar = ()=>{
    ...
    const hrRef = (0,external_react_.useRef)(`${"http://localhost:1337"}/uploads/Novatech_logo_orange_86fed35a20.svg`);
...
const NtWhiteLogo = ()=>{
    const hrRef = (0,external_react_.useRef)(`${"http://localhost:1337"}/uploads/Novatech_logo_white_9de520791f.svg`);
