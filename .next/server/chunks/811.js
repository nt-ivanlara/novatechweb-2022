...
const SimpleBanner = ({ title , subtitle , description , hero , background , isFloating , haveAction , actionLabel , actionRoute , centered , styles  })=>{
    ...
    const hrRef = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(`${""}${(heroFormats === null || heroFormats === void 0 ? void 0 : (ref2 = heroFormats.medium) === null || ref2 === void 0 ? void 0 : ref2.url) ?? (heroFormats === null || heroFormats === void 0 ? void 0 : heroFormats.thumbnail.url)}`);
    const bgUri = (0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(`${""}${(bgFormats === null || bgFormats === void 0 ? void 0 : (ref3 = bgFormats.large) === null || ref3 === void 0 ? void 0 : ref3.url) ?? (bgFormats === null || bgFormats === void 0 ? void 0 : bgFormats.thumbnail.url)}`);
